...
- [Awesome ways of using callbacks](#awesome-ways-of-using-callbacks) <a href='https://github.com/novoforce/Exploring-Tensorflow/blob/main/README.md#Awesome-ways-of-using-callbacks' target='_blank'><img src='https://img.shields.io/static/v1?label=Awesome%20ways%20of%20using%20callbacks&message=Tutorial&color=yellow&style=flat-square' border='0' alt='Awesome ways of using callbacks'/></a>
